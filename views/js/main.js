...
var resizePizzas = function(size) {
  ...
  //Removed the variables from within the loop so as to avoid the overhead of calculating the value multiple times.
...
//Replaced querySelector with getElementById
//Declaration of pizzasDiv outside the loop to avoid overhead
...
//Replaced querySelectorAll with getElementsByClassName
//updated variable in for loop declaration to not have to check the items length over and over
